...
def compute_Ix(imgs):
    ...
    ----------
    imgs : numpy array
        Set of images / frames to compute gradient in X dimension; shape: (H, W, N)
        
    Returns
    -------
    Ix : numpy array
        Image gradient along the X-dimension;  shape: (H, W, N)
    '''
    ...
    # cycle through the images / frames in a video sequence
    ...
    #===========================================================================
    # CONVOLUTION USING G in temporal direction (time axis)
    #===========================================================================
...
def compute_Iy(imgs):
    ...
    ----------
    imgs : numpy array
        Set of images / frames to compute gradient in Y dimension; shape: (H, W, N)
        
    Returns
    -------
    Iy : numpy array
        Image gradient along the Y-dimension;  shape: (H, W, N)
    '''
    ...
    for frame in range(total_frames):
        ...
        # cycle through the rows in Iy[:,:,n] to perform guassian operations i.e y dir
...
def compute_It(imgs):
    '''
    Compute the gradient of the images along the time-dimension.

    Parameters
    ----------
    imgs : numpy array
        Set of images / frames to compute gradient in time dimension; shape: (H, W, N)
        
    Returns
    -------
    It : numpy array
        Image gradient along the time-dimension;  shape: (H, W, N)
    '''
